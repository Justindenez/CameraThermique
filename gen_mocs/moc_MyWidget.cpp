...
QT_MOC_LITERAL(1, 9, 4), // "clic"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 7), // "Mouse_X"
QT_MOC_LITERAL(4, 23, 7), // "Mouse_Y"
QT_MOC_LITERAL(5, 31, 5) // "close"

    },
    "MyWidget\0clic\0\0Mouse_X\0Mouse_Y\0close"
};
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clic((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (MyWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWidget::clic)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWidget::close)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyWidget::clic(int _t1, int _t2)
{
