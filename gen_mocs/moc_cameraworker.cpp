...
QT_MOC_LITERAL(6, 49, 6), // "doWork"
QT_MOC_LITERAL(7, 56, 8) // "stopWork"

    },
    "CameraWorker\0handleImage\0\0QImage&\0"
    "image\0finished\0doWork\0stopWork"
};
...
void CameraWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWorker::handleImage)) {
                *result = 0;
                return;
            }
        }
